...
export const BesimplitIntro: React.FC = () => {
  const frame = useCurrentFrame();
  const {width, height} = useVideoConfig();

  return (
    <AbsoluteFill style={{backgroundColor: bg}}>
      {/* Fondo con logo arriba izquierda */}
      <AbsoluteFill
        style={{
          padding: 80,
          display: 'flex',
      ...
      >
        ...
        <Sequence from={0} durationInFrames={270}>
          ...
          >
            ...
            >
              ...
              <Bullet>Gestión de mantención, documentación y checklists de maquinaria.</Bullet>
            </div>
          </div>
        </Sequence>

        {/* 2) Bediesel - Control de petróleo */}
        ...
        <Sequence from={990} durationInFrames={810}>
          <div
            style={{
              flex: 1,
              display: 'flex',
          ...
          >
            ...
            <div style={{marginTop: 24}}>
              <Bullet>Constructoras de movimiento de tierra y obras viales.</Bullet>
